...
- Timestamp: `2022-06-14 02:00`
- Build ID: `8b5fe6d9-905d-49d5-a3a2-6ca668a18883`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8b5fe6d9-905d-49d5-a3a2-6ca668a18883.git
$ cd 8b5fe6d9-905d-49d5-a3a2-6ca668a18883
```
